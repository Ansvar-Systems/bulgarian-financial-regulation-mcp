...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in Bulgarian or English" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., FSC_NAREDBI, BNB_NAREDBI). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific FSC provision by sourcebook and reference (e.g., FSC_NAREDBI / 'Наредба 38').",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., FSC_NAREDBI, FSC_UKAZANIYA, BNB_NAREDBI)" },
        reference: { type: "string", description: "Provision reference (e.g., 'Наредба 38')" },
      },
  ...
  },
  {
    ...
    description: "List all FSC and BNB sourcebook collections with names and descriptions.",
  ...
  },
  {
    ...
    description: "Check whether a specific FSC provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "Provision reference (e.g., 'Наредба 38')" },
