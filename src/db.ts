/**
 * SQLite database access layer for the Bulgarian FSC (КФН) MCP server.
 *
 * Schema:
 *   - sourcebooks        — FSC sourcebook directories (FSC_Naredbi, FSC_Ukazaniya, BNB_Naredbi)
 *   - provisions         — individual ordinances, instructions, and regulatory provisions
 *   - enforcement_actions — FSC enforcement decisions and sanctions
 *
